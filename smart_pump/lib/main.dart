            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Erreur Firebase', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Text(_erreur, style: const TextStyle(color: Colors.red, fontSize: 12), textAlign: TextAlign.center),
                  const SizedBox(height: 24),
                  ElevatedButton(
                    onPressed: () => setState(() { _erreur = ''; _initialiser(); }),
          ...
          body: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24),
                Text('Smart Pump', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                SizedBox(height: 16),
